...
public partial class WarbandDetailPage : ContentPage
{
    public WarbandDetailPage(WarbandDetailViewModel viewModel)
    {
        ...
        // son texte et se centrerait décalé par rapport à WarriorCollection.
        if (DeviceInfo.Current.Idiom == DeviceIdiom.Desktop)
        {
            Header.WidthRequest = 560;
            Header.HorizontalOptions = LayoutOptions.Center;
            WarriorCollection.WidthRequest = 560;
            WarriorCollection.HorizontalOptions = LayoutOptions.Center;
        }
    }
}
