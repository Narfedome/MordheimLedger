...
/// <summary>Pipeline de persistance de Fin de Partie (Apply*Async), déplacé tel quel depuis
/// WarbandDetailViewModel.EndOfGame.cs (2026-09-22, passage en page Shell - voir CLAUDE.md) : pur
/// déplacement de méthode, chaque Apply*Async perd juste son paramètre EndOfGamePageViewModel
/// dialogViewModel (devient un this implicite) puisque ce pipeline vit maintenant SUR ce ViewModel
/// plutôt qu'à côté. Appelé une seule fois, dans l'ordre ci-dessous, par FinishAsync (EndOfGamePageViewModel.cs).
/// </summary>
