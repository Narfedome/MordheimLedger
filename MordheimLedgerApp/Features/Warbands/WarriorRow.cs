...
public partial class WarriorRow : ObservableObject
{
    ...
    /// <summary>Mirrors Warrior.Mount - read-only display, managed via WarriorEditDialog.</summary>
    public Mount? Mount => Warrior.Mount;
    ...
    public bool HasMount => Mount is not null;
